...
class TongueDataset(data.Dataset):
    ...
    def getDataPath(self):
        self.train_img_paths = glob(self.root + r'/train/*')
        self.train_mask_paths = glob(self.root + r'/train_mask/*')
        self.val_img_paths = glob(self.root + r'/val/*')
        self.val_mask_paths = glob(self.root + r'/val_mask/*')
        self.test_img_paths = glob(self.root + r'/test/*')
        self.test_mask_paths = glob(self.root + r'/test_mask/*')
